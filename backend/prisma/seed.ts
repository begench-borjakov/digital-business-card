...
async function main(): Promise<void> {
  ...
  try {
    const wasSeeded = await prisma.$transaction(async (tx) => {
      ...
      const profile = await tx.profile.create({
        data: {
          ...
          linkedinUrl: 'https://linkedin.com/in/begench-borjakov-862b84395',
          location: null,
        },
      });
      ...
      await tx.project.createMany({
        data: [
          ...
          },
          {
            ...
            technologies: 'NestJS, TypeScript, React, Vite, Zustand, Docker',
      ...
      await tx.experience.createMany({
        data: [
          ...
          },
          {
            ...
            current: false,
            description:
              'Developed a TypeScript SDK for the Ontology blockchain.',
            highlights: [
              'Key generation',
              'Address generation',
          ...
          },
          {
            ...
            current: false,
            description:
              'Developed REST API endpoints using Node.js and Express.js.',
            highlights: [
    ...
    console.log(
      wasSeeded
        ...
        : 'Database already contains a profile, skipping seed',
    );
  } finally {
